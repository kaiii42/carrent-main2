		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header" style="background: url(<?= base_url()?>demos/pet/images/banner4.png); ) center right no-repeat; background-size: cover;">
				...
				<div class="vertical-middle">
					<div class="container py-5">
						<div class="emphasis-title dark m-0">
							...
							<h1 style="font-size: 50px; line-height: 1.4; font-weight: 600; text-shadow: 1px 1px 1px rgba(0,0,0,0.5);">Halo,<br> <?php echo session('nama'); ?> !</h1><br>
							<a href="#" class="button button-large button-rounded ml-0">My Dashboard</a><span class="leftmargin-sm">
							...
							<a href="#" class="button button-large button-rounded ml-0">Cek Status</a><span class="leftmargin-sm">
